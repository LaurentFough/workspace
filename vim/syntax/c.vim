...
" Mes modifications
"syn match cChamps "\.\h\w*" contains=cAccesseur
"syn region cChamps start="->" end="\ " 
"hi def link cChamps cIdentifier

"syn match cAccesseurPoint "\."
"syn match cAccssseurfleche "->"
"hi def link cAccesseurPoint cAccesseur
"hi def link cAccssseurfleche cAccesseur
"hi def link cAccesseur Delimiter
