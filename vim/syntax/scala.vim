...
syn keyword mineConditionnal if else match
syn keyword mineStorageClass final private protected
syn keyword mineDefClass abstract extends with
syn keyword mineException try catch throw
syn keyword mineRepeat for do while
syn keyword mineTypedef type
syn keyword minePattern with case
syn keyword mineOperator new return super this
syn keyword mineConstant null
syn keyword mineKeyword finally forSome implicit lazy override requires sealed yield
...
hi link mineConditionnal Conditional
hi link mineStorageClass StorageClass
hi link mineDefClass Keyword
hi link mineException Exception
hi link mineRepeat Repeat
hi link mineTypedef Typedef
hi link minePattern Label
hi link mineOperator Operator
hi link mineKeyword Keyword
hi link mineConstant Constant
